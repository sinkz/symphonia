defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Agent do
    ...
    def changeset(schema, attrs) do
      ...
      |> cast(
        attrs,
        [:provider, :max_concurrent_agents, :max_turns, :max_retry_backoff_ms, :max_concurrent_agents_by_state],
        empty_values: []
      )
  ...
  defmodule OpenCode do
    ...
    embedded_schema do
      ...
      field(:model, :string)
      field(:agent, :string)
      field(:run_timeout_ms, :integer, default: 3_600_000)
    ...
    def changeset(schema, attrs) do
      ...
      |> cast(
        attrs,
        [:command, :model, :agent, :run_timeout_ms, :format, :dangerously_skip_permissions],
        empty_values: []
      )
      |> validate_required([:command, :format])
      |> validate_number(:run_timeout_ms, greater_than: 0)
    end
  end
